...
$myPlugins['easy-pagespeed'] = array('value' => 'Easy PageSpeed',
    'price' => '6.95',
    'share' => false,
    'long' => false,
    'blurb' => '<em><strong>Easy PageSpeed</strong></em> rewrites the local links in your blog pages to point to the CDN as you specify. It also removes the version query strings that WordPress adds to static files so that they can be cached. This unique plugin ',
    'desc' => 'replaces part of the functionality that caching plugins provide, and is useful if you do not need caching, but only CDN re-writing.',
    'title' => '<em><strong>Easy PageSpeed</strong></em> can improve your page speed scores and actual response times by helping you use CDNs and browser caching.',
    'pro' => 'The Lite version of <em><strong>Easy PageSpeed</strong></em> is fully functional. In the Pro version, you can specify multiple CDN addresses (or multiple groups) serving the the file types that you specify. It also gives you more control over the types of files (specified by their extensions) that you want to serve out of the CDN.');

$myPlugins['easy-object-cache'] = array('value' => 'Easy Object Cache',
    'price' => '6.95',
    'share' => false,
    'long' => false,
    'blurb' => '<em><strong>Easy Object Cache</strong></em> generates the drop-in plugin <code>object-cache.php</code> in your plugins folder based on your configuration, providing APCu functionality if not available on your server. This simple and efficient plugin ',
    'desc' => 'can free up your database by moving the transient storage to a shared memory or disk file.',
    'title' => '<em><strong>Easy Object Cache</strong></em> can free up your database by moving the transient storage to a shared memory or disk file..',
    'pro' => 'The Lite version of <em><strong>Easy Object Cache</strong></em> is fully functional. In the Pro version, you can specify the actual size of the cache storage, and its location and time-to-live. It also gives you statistics and detailed info about the cached files. And it can clean up your database to get rid of transients thereby further improving performance.');

$myPlugins['easy-cache'] = array('value' => 'Easy Cache',
    'price' => '13.95',
    'share' => false,
    'long' => false,
    'blurb' => '<em><strong>Easy Cache</strong></em> is the only caching plugin specifically designed for mobile devices. This remarkable plugin ',
    ...
    'title' => '<em><strong>Easy Cache</strong></em> is the only plugin desgined from ground up with mobile devices in mind.',
    'pro' => 'If you like <em><strong>Easy Cache</strong></em> , you will love its Pro version! It brings the same wickedly optimized caching algorithm to desktop browsers as well, and creates independent static caches for desktop, tablets and smart phones with their own customized settings.',
...
<li>Ability to pre-populate the cache so that <strong>Easy Cache</strong> behaves like a warm cache.</li>
...
$myPlugins['mobile-cache'] = $myPlugins['easy-cache'];
