...
public class AptekarzMode extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if(m_Imie == null || m_Nazwisko == null)
        {
            m_Imie = "";
            m_Nazwisko = "";
        }
        setActionBar("Witaj: " + m_Imie + " " + m_Nazwisko + " w trybie aptekarza");

        m_Form = findViewById(R.id.ListOfElements);
        m_ProgressBar = findViewById(R.id.aptekarz_progress);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                intent.putExtra("AptekarzMode", true);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item)
    {
        ...
        switch(id)
        {
            ...
            case R.id.medicines:
                ...
                startActivity(intent);
                break;
            case R.id.oczekujace_zamowienia:
                ...
                break;
            case R.id.Klienci:
                intent = new Intent(context, ListaKlientowActivity.class);
                intent.putExtra("ID", ID);
                startActivity(intent);
                break;
            case R.id.MojeKonto:
    ...
    private class Task extends AsyncTask<Void, Void, Boolean>
    {
        ...
        protected void onPostExecute(final Boolean succes)
        {
            ...
            else
            {
                if(Finish || succes)
                {
                    Toast.makeText(AptekarzMode.this,"Pobrano dane z serwera!", Toast.LENGTH_LONG).show();
                    setLists();
                }
                else
                {
                    Toast.makeText(AptekarzMode.this,"Błąd podczas pobierania danych!", Toast.LENGTH_LONG).show();
                }
            }
        }
